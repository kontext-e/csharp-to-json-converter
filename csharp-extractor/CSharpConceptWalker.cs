...
namespace CSharpExtractor
{
    ...
    class CSharpConceptWalker : CSharpSyntaxWalker
    {
        ...
        public override void VisitIdentifierName(IdentifierNameSyntax node)
        {
            ...
            {
                IFieldSymbol fieldSymbol = symbol.Symbol as IFieldSymbol;
                element.Add(new XAttribute("Type", TypeName(fieldSymbol.Type)));
            }
            else if (symbol.Symbol is IPropertySymbol)
            {
                IPropertySymbol propertySymbol = symbol.Symbol as IPropertySymbol;
                element.Add(new XAttribute("Type", TypeName(propertySymbol.Type)));
            }
            else if (symbol.Symbol is IParameterSymbol)
            {
                IParameterSymbol parameterSymbol = symbol.Symbol as IParameterSymbol;
                element.Add(new XAttribute("Type", TypeName(parameterSymbol.Type)));
            }
        ...
        /// </summary>Parameter
        /// <param name="node">The node describing this Visit.</param>
